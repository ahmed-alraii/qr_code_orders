...
Route::resource('/orders' , OrderController::class)->middleware(['auth' , 'is_employee']);
Route::post('/orders/send_order' , [OrderController::class , 'sendOrder'])->name('orders.send_order');
